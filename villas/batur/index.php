...
/* =========================================================
   ...
   >>> DUA HAL YANG PERLU DIISI <<<
   1. 'price'  — harga Villa Batur belum saya ketahui.
   2. 'desc'   — teks di bawah SAYA SUSUN dari daftar fitur
                 resmi, BUKAN terjemahan dari copy asli
                 halaman Inggrisnya. Ganti dengan terjemahan
                 teks resmi begitu tersedia.
   ========================================================= */
...
$villa = [
    ...
    'name_latin'  => 'Batur',
    'tagline'     => '一处静止的庇护',
    'specs'       => '2 卧室 · 424 m² · 4 位宾客 · 3 层',

    /* PERLU DIISI — harga Villa Batur */
    'price'       => 'IDR 9,400,000',
    'price_unit'  => '/ 晚',
    'price_note'  => '门市价 · 含每日早餐',

    'hero'        => 'assets/villas/gallery/batur/batur-hero.jpg',
    'hero_alt'    => '巴图尔别墅与独立层无边泳池',

    'desc'        => '巴图尔为安静而生。三层的布局让每一处空间都有自己的距离——'
                   . '起居区从容舒展，主卧套房安放在最不受打扰的一角，'
                   . '而无边泳池独占一层，向着森林与河谷敞开。'
                   . '落地窗把绿意整片引入室内，屋顶露台则留给傍晚与星空。'
                   . '这里没有需要赶赴的行程，只有一天里逐渐慢下来的节奏。',
    ...
    'floors'      => [
        ['name' => '一层', 'rooms' => '起居与用餐区 · 客卧'],
        ['name' => '二层', 'rooms' => '主卧套房 · 阳台'],
        ['name' => '三层', 'rooms' => '无边泳池 · 屋顶露台'],
    ],

    'gallery'     => [
        ['file' => '01', 'alt' => '巴图尔别墅外观',     'size' => 'large'],
        ['file' => '04', 'alt' => '独立层无边泳池',     'size' => 'tall'],
        ['file' => '05', 'alt' => '屋顶露台',           'size' => 'half'],
        ['file' => '06', 'alt' => '浴室与浴缸',         'size' => 'half'],
        ['file' => '07', 'alt' => '客卧',               'size' => 'tall'],
        ['file' => '08', 'alt' => '森林与河谷景观',     'size' => 'large'],
        ['file' => '09', 'alt' => '森林与河谷景观',     'size' => 'tall'],
    ],

    'seo_title'   => '巴图尔别墅 | 帕拉乌布度假村 · 巴厘岛乌布两卧室私人泳池别墅',
    'seo_desc'    => '巴图尔别墅：两卧室静谧别墅，424 m²，三层布局，'
                   . '配独立层无边泳池、屋顶露台与森林河谷景观，'
                   . '位于巴厘岛乌布帕拉乌布度假村。',
];
...
<body>
  ...
  <?php require TPR_ROOT . '/header.php'; ?>
   ...
   <?php if (!empty($villa['gallery'])): ?>
      <?php
      $gal_dir = rtrim($villa['gallery_dir'] ?? 'assets/villas/gallery/batur', '/');
      ?>
